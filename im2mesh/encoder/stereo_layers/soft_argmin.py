...
def soft_argmin(input):
    # Calculates argmin between channels
    # Not actually sure why we use the index as cost??
    ...
    # print('idx tensor: ', index_tensor.shape)
    # print('softmin: ', softmin)
    # print('softmin and index: ', (softmin * index_tensor))
