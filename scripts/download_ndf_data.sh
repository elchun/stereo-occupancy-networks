...
mkdir -p $STEREO_SOURCE_DIR/data/training_data
mv ndf_*_data.tar.gz $STEREO_SOURCE_DIR/data/training_data
sleep 5
ls $STEREO_SOURCE_DIR/data/training_data
cd $STEREO_SOURCE_DIR/data/training_data
...
echo "Training data NDF copied to $STEREO_SOURCE_DIR/data/training_data"
fi